...
export const ListClientsResponse = zod.object({
  data: zod.array(
    zod.object({
      ...
      leadSource: zod.string().nullable().optional(),
      referrerClientId: zod.number().nullable().optional(),
      selfCheckCitizenshipUz: zod.boolean().nullable().optional(),
      selfCheckSixMonthsOperation: zod.boolean().nullable().optional(),
      selfCheckPredominantlyPrivate: zod.boolean().nullable().optional(),
      selfCheckBranchServiceArea: zod.boolean().nullable().optional(),
      purpose: zod.string().nullable().optional(),
