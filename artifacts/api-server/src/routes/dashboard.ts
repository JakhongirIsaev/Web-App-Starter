...
router.get("/admin/activity-log", guestAuth, requireRole("superadmin", "head_office_admin"), async (req, res) => {
...
router.get("/admin/activity-log/types", guestAuth, requireRole("superadmin", "head_office_admin"), async (_req, res) => {
  const rows = await db
